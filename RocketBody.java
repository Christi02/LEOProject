/**
     * This class is designed to model the rocketbody objects.
     *
...
public class RocketBody extends SpaceObject{
    ...
    /**
     * 
     * @param objects the array for Rocketbody list
     */
    public static void printRocketBodyData(RocketBody[] objects) {
        for (RocketBody obj : objects) {
            if (obj != null) {
